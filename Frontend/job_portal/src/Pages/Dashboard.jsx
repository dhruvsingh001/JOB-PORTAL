...
const Dashboard = () => {
     ...
     // The company profile is fetched after the saved token is restored.
     // Keep the dashboard from reading name/image before that request finishes.
     if (!companyData) {
  ...
  return (
        <div className='min-h-screen'>
                    ...
                    <img onClick={e => navigate('/')} className='max-sm:w-32 cursor-pointer' src={assets.logo} alt="" />
                        ...
                        <div className='flex items-center gap-3'>
                            ...
                            <div className='relative group'>
                                <img className='w-8 border rounded-full' src={companyData.image} alt="hh" />
            ...
            <div className='flex items-start'>
                ...
                <div className='inline-block w-1/5 min-h-screen border-r-2'>
